    ...
    @if (count($revisions) > 0)
        <table class="table table-striped table-hover">
            ...
            <tr>
                ...
                <th>{!! columnSort('Local', ['field' => 'revisionable_type', 'sort' => 'asc']) !!}</th>
                <th>{!! columnSort('Usuário', ['field' => 'user_id', 'sort' => 'asc']) !!}</th>
                <th>Ação</th>
                <th>{!! columnSort('Registro', ['field' => 'revisionable_id', 'sort' => 'asc']) !!}</th>
                <th>{!! columnSort('Data', ['field' => 'created_at', 'sort' => 'asc']) !!}</th>
            </tr>
            </thead>
            <tbody>
...
@section('pagination-showing')
    @include('mixdinternet/admix::partials.pagination-showing', ['model' => $revisions])
@endsection